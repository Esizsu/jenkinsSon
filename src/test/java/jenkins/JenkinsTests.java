...
public class JenkinsTests {
    ...
    public void apiTest(){
        ...
        //validation
        // responseun data type map ile uygun olmali o yuzden hashmap yazdik. Class ta bu classtan demek icin
        // hashmap is a implementing from his interface.
        ...
        assertEquals(844, actualData.get("totalprice"));
        assertEquals(true, actualData.get("depositpaid"));

        assertEquals("2019-05-01", bookingdates.get("checkin"));
        assertEquals("2019-11-02", bookingdates.get("checkout"));
